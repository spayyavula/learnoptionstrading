/*
  ...
  1. New Tables
    - `historical_data` - Stock historical price data
    - `options_historical_data` - Options historical price and Greeks data
    - `user_portfolios` - User portfolio balances and values
