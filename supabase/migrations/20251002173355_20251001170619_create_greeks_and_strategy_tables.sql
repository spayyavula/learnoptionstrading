/*
  ...
  1. New Tables
    - `contracts_watchlist` - User watchlist for options contracts
    - `greeks_snapshots` - Historical Greeks snapshots
    - `strategy_templates` - User-created strategy templates
    - `scenario_analysis` - Strategy scenario analysis results
    - `greeks_alerts` - Alerts for Greeks thresholds
